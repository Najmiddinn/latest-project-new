 ...
 */
class AwsS3 extends AwsS3Adapter implements ContainerAwareInterface
{
    /**
     * @var CKFinder
     */
    ...
    /**
     * Emulates changing directory name
     *
     * @param string $path
    ...
    /**
     * Helper method that replaces part of the key (path)
     *
     * @param string $objectPath bucket-relative object path
     * @param string $path       old backend relative path
     * @param string $newPath    new backend relative path
     *
     * @return string new bucket-relative path
     */
