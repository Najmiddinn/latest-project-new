...
@section('title') Monitoring @endsection
@section('content')
    ...
    <div class="card">
            ...
            <div class="breadcrumb-and-filter">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{route('borowwing-filter.index')}}" method="GET" style="display: flex;align-items:center">
                            {{-- @csrf --}}
                            ...
                            <div style="margin: 15px 5px 0 5px">
                                <a href="{{route('borowwing-filter.index')}}" class=" style-add btn btn-primary">Filterni bekor qilish</a>
                            </div>
                        </form>
                        </div>
                    </div>
        ...
        <div class="card-body">
            @if (!empty($filterbydatefrom) && !empty($filterbydateto))
                <p><b>{{$filterbydatefrom  }}</b> dan <b>{{$filterbydateto}}</b> gacha berilgan va qaytarilgan kitoblar soni <b>{{count($models)}}</b> ta</p>
            @else
                <p>Oxirga 1 oy ichida berilgan va qaytarilgan kitoblar soni <b>{{($models->total())}}</b> ta</p>
            @endif
            <p>shundan <b>{{$borowwingNoReturn->count()}}</b> ta kitob berilgan</p>
            <p>shundan <b>{{ $borowwingReturn->count()}}</b> ta kitob qaytarilgan</p>
