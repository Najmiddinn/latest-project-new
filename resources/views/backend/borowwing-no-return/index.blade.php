...
@section('title') Topshirilmagan kitoblar @endsection
@section('content')
    ...
    <div class="card">
        <div class="content-header">
            <div class="container-fluid card-block">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Topshirilmagan kitoblar</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/">{{__('msg.Home')}}</a></li>
                            <li class="breadcrumb-item active">Topshirilmagan kitoblar</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
            ...
            <div class="breadcrumb-and-filter">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{route('borowwing-no-return.index')}}" method="GET" style="display: flex;align-items:center">
                            {{-- @csrf --}}
                            ...
                            <div style="margin: 15px 5px 0 5px">
                                <a href="{{route('borowwing-no-return.index')}}" class=" style-add btn btn-primary">Filterni bekor qilish</a>
                            </div>
                        </form>
                        </div>
                    </div>
        ...
        <div class="card-body">
            <p>Barcha topshirilmagan kitoblar soni <b>{{$borowwingNoReturn}}</b> ta</p>
