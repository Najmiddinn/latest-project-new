...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <p>Barcha talabalar soni <b>{{$studentCount}}</b> ta</p>
            @foreach ($studentcategories as $studentcategory)
                @if ($studentcategory->id != 3)
                <li class="list-group-item">{{$studentcategory->course_name}} da <b>({{ $studentcategory->course->count()}})</b> ta talaba bor</a></li>
                @endif
